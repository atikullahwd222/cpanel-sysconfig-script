...
echo -e "${YELLOW}Please complete the server basic configuration${NC}"
echo -e "${YELLOW}before proceeding with installation!${NC}"
echo -e "${CYAN}Select option 1 for server preparation.${NC}"
echo -e "${RED}**********************************************${NC}"
echo ""
