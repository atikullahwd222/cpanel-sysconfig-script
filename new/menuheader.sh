...
# Version
SCRIPT_VERSION=$(curl -shttps://raw.githubusercontent.com/atikullahwd222/cpanel-sysconfig-script/refs/heads/main/new/version.sh) | grep 'SCRIPT_VERSION=' | cut -d'=' -f2 | tr -d '"')
